...
import com.femfy.femfyapi.delivery.mapper.QuestionsUserAnotherCongenitalCausesMapper;
...
public class QuestionsUserAnotherCongenitalCausesController {
    ...
    public ResponseEntity<?> getAllCongenitalCauses() {
        List<QuestionsUserAnotherCongenitalCausesDTO> congenitalCauses = congenitalCausesService.getAllQuestionsUserAnotherCongenitalCauses().stream()
                																				.map(QuestionsUserAnotherCongenitalCausesMapper::mapToDTO)
    ...
    public ResponseEntity<QuestionsUserAnotherCongenitalCausesDTO> createCongenitalCause(@RequestBody QuestionsUserAnotherCongenitalCausesDTO causeDTO) {
        QuestionsUserAnotherCongenitalCausesDTO createdCause = QuestionsUserAnotherCongenitalCausesMapper.mapToDTO(congenitalCausesService.saveQuestionsUserAnotherCongenitalCauses(QuestionsUserAnotherCongenitalCausesMapper.mapToEntity(causeDTO)));
    ...
    public ResponseEntity<QuestionsUserAnotherCongenitalCausesDTO> updateCongenitalCause(@RequestBody QuestionsUserAnotherCongenitalCausesDTO causeDTO) {
        ...
        QuestionsUserAnotherCongenitalCausesDTO updatedCause = QuestionsUserAnotherCongenitalCausesMapper.mapToDTO(congenitalCausesService.updateQuestionsUserAnotherCongenitalCauses(QuestionsUserAnotherCongenitalCausesMapper.mapToEntity(causeDTO)));
    ...
    public ResponseEntity<?> getAllCongenitalCausesByUser(@PathVariable("userId") Long userId) {
        List<QuestionsUserAnotherCongenitalCausesDTO> congenitalCauses = congenitalCausesService.getAQuestionsUserAnotherCongenitalCausesByUserId(userId).stream()
                																				.map(QuestionsUserAnotherCongenitalCausesMapper::mapToDTO)
                																				.collect(Collectors.toList());
        return buildResponse(congenitalCauses);
    }
